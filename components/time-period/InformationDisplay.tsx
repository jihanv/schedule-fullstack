...
export default function InformationDisplay() {
  ...
  const setShowWeeklyPreview = useTimePeriodStore(
    (s) => s.setShowWeeklyPreview,
  );
  ...
  const normalizeScheduleForSave = (
    schedule: Record<string, Record<number, string | undefined>>,
  ) => {
      ...
      <div className="flex flex-col sm:w-132.5 items-center p-10 border mt-10">
        ...
        <div className="flex flex-col gap-2 pt-5 sm:justify-center items-center">
          ...
          <Dialog open={showSuccess} onOpenChange={setShowSuccess}>
            <DialogContent className="w-[92vw] max-w-md p-8 text-center">
              <DialogHeader>
